...
**Death is permanent.** If you die, your run is over.
...
- **Named community zombies** scattered through the infected
...
1. Download the latest release from the [Releases page](https://github.com/Frilioth/FrilArea7Challenge/releases)
...
| Air Drops | Disabled |
| Loot Respawn | 5 days |
| Biome Progression | Off |

## Included Modlets

| Modlet | Description |
|---|---|
| FrilArea7Challenge | Main mod — DLL, config, world, prefabs, challenges |
| zzArea7ExtractionMod | Helicopter extraction sequence |
| FrilArea7MenuMusic | Original main-menu theme |
| FrilArea7Logo | Menu branding — logo and background video |
| FrilArea7MenuVideoCycler | Rotating security-camera menu feeds |
| FrilArea7ESCGuide | In-game ESC guide panel |
| 0_Area7Items | Custom items, Unity3D resources, UI atlases |
...
- **Nexus Mods:** [Area 7 Challenge on Nexus](https://www.nexusmods.com/7daystodie/mods/)
- **7DTD Mods:** [7daystodiemods.com](https://7daystodiemods.com/)

## Credits

Created by **Frilioth**

- **bdubyah** — UH-60 helicopter mod, bundled with permission ([Nexus](https://www.nexusmods.com/7daystodie/mods/755))
- **AuroraGiggleFairy (AGF)** — the ESC-window technique the in-game guide is built on (built fresh, not copied)
